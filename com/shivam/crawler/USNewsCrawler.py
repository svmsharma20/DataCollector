...
url_list=["https://www.usnews.com/education/best-global-universities/search?country=australia&country=canada&country=denmark" \
    "&country=france&country=germany&country=greece&country=italy&country=netherlands&country=singapore&country=spain" \
    "&country=sweden&country=switzerland&country=united-kingdom&subject=computer-science",
          "https://www.usnews.com/education/best-global-universities/search?country=canada&subject=computer-science&name=",
          "https://www.usnews.com/education/best-global-universities/search?country=canada&subject=&name="]

filter_list=["UniversitiesAllCSE", "UniversitiesCanadaCSE", "UniversitiesCanadaGeneralRanking"]

filter=1

next_url=url_list[filter]
# next_url= "https://www.usnews.com/education/best-global-universities/search?country=australia&country=canada&country=denmark" \
#     "&country=france&country=germany&country=greece&country=italy&country=netherlands&country=singapore&country=spain" \
#     "&country=sweden&country=switzerland&country=united-kingdom&subject=computer-science"
...
# df.to_csv( filter_list[filter]+'.csv', index=False, encoding='ISO-8859-1')